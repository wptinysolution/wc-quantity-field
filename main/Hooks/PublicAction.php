...
class PublicAction {
	...
	private function __construct() {
        ...
        $this->loader->add_action('wp_ajax_wcqf_update_order_review', $this, 'wcqf_update_order_review');
        $this->loader->add_action('wp_ajax_nopriv_wcqf_update_order_review', $this, 'wcqf_update_order_review');
    }
