...
class Upgrade {
	...
	public function version_update_warning( $plugin_data ) {
		...
		?>
		<div class="ancenter-major-update-warning">
			<div class="ancenter-major-update-icon">
				<i class="dashicons dashicons-info"></i>
			</div>
			<div>
				<div class="ancenter-major-update-title">
					<?php
					printf(
						'%s%s.',
				...
				<div class="ancenter-major-update-message">
	...
	public function upgrade_styles() {
		...
		echo '<style>
			...
			.ancenter-major-update-icon i {
				color: #d63638;
				margin-right: 8px;
			}

			.ancenter-major-update-warning + p {
				display: none;
			}

			.ancenter-major-update-title {
				font-weight: 600;
				margin-bottom: 10px;
			}

			.notice-success .ancenter-major-update-warning {
				border-color: #46b450;
			}

			.notice-success .ancenter-major-update-icon i {
				color: #79ba49;
			}
		</style>';
	}
